<div class="view-section fade-in space-y-6">
    ...
    <div class="border-b border-slate-700 flex gap-6 text-sm">
        <button wire:click="switchTab('users')" class="pb-3 border-b-2 transition-colors <?php echo e($activeTab === 'users' ? 'border-primary-500 text-white font-bold' : 'border-transparent text-slate-400 hover:text-white'); ?>">User Management</button>
        <button wire:click="switchTab('logs')" class="pb-3 border-b-2 transition-colors <?php echo e($activeTab === 'logs' ? 'border-primary-500 text-white font-bold' : 'border-transparent text-slate-400 hover:text-white'); ?>">Activity Logs</button>
    </div>
